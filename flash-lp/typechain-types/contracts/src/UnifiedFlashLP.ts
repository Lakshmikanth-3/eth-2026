...
export interface UnifiedFlashLPInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "setApprovalForAll"
      | "setPlatformFee"
      | "setYellowChannelManager"
      | "settleRentalWithYellow"
      | "supportedChains"
      | "supportsInterface"
      | "symbol"
      | "tokenURI"
  ...
  encodeFunctionData(
    functionFragment: "setYellowChannelManager",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "settleRentalWithYellow",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
...
export interface UnifiedFlashLP extends BaseContract {
  ...
  setYellowChannelManager: TypedContractMethod<
    [_newManager: AddressLike],
    [void],
    "nonpayable"
  >;

  settleRentalWithYellow: TypedContractMethod<
    [
      rentalId: BigNumberish,
  ...
  getFunction(
    nameOrSignature: "setYellowChannelManager"
  ): TypedContractMethod<[_newManager: AddressLike], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "settleRentalWithYellow"
  ): TypedContractMethod<
    [
      rentalId: BigNumberish,
      finalBalance1: BigNumberish,
